...
describe TodoList do
  ...
  describe "Setting hashids correct" do
    it "encodes the hashid based on id" do

    end

    it "decodes the id based on hashid" do
  ...
  describe "#has_completed_items?" do
    ...
    it "returns false when no completed todo list items" do
